export const E = (ref) => {
  ...
  animations.push(["mixamorigRightArm", "rotation", "z", Math.PI/17, "+"]);
  ...
  // animations.push(["mixamorigLeftArm", "rotation", "x", Math.PI/24, "+"]);//leg to head move
  // animations.push(["mixamorigLeftArm", "rotation", "y", -Math.PI/7, "-"]);//hand to hand move
